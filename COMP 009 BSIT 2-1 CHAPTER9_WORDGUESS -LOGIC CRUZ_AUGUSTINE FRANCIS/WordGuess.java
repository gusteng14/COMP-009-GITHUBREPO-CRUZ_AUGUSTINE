...
public class WordGuess {
	...
	private void validateGuess(char letter) {
		...
		if(!correct) {
			String[] ok = {"Continue"};
			JOptionPane.showOptionDialog(frame, "Please try again.", "Wrong guess!", JOptionPane.OK_OPTION, JOptionPane.PLAIN_MESSAGE, null, ok, null);
			mistakes++;
		} else {
